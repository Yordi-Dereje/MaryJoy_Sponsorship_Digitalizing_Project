...
import { X, Upload, FileText, LucideFile } from "lucide-react";
      ...
      >
        <div className="flex justify-between items-center mb-4 pb-4 border-b border-gray-200">
          <h2 className="text-xl font-bold text-blue-700">
            Add {beneficiaryType === "child" ? "Child" : "Elder"} Beneficiary
          </h2>
          <button
              ...
              <div className="mt-4">
                ...
                >
                  ...
                  <input
                    ...
                    accept=".pdf,.jpg,.png"
                    onChange={(e) =>
                      setupFileUpload("bankFilePreview", e.target.files[0])
                    }
                  />
                </div>
                <div id="bankFilePreview" className="mt-2"></div>
              </div>
            </div>
          </>
        )}
